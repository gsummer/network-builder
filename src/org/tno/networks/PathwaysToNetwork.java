...
public class PathwaysToNetwork {
	...
	Graph parseInteractions(Iterable<Pathway> pathways,Graph graph) throws IDMapperException {
	...
	public static void main(String[] args) {
		try {
			...
			if(pargs.getNeo4jConfig() != null && !pargs.getNeo4jConfig().isEmpty()){
				g = new Neo4jGraph(pargs.getNeo4jConfig());
			} else {
				g = new InMemoryGraph();
			}

			ptn.parseInteractions(dpws.getIterable(),g);
	...
	private interface Args extends AIDMapper, AHelp, APathways, AHomology, ANeo4j {
		@Option(shortName = "o", description = "The name of the output file (.gml or .xgmml).",defaultToNull=true)
		public File getOut();
